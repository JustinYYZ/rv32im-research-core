...
module rv32_rob_storage_tb;
  ...
  rv32_rob dut (
    ...
    .complete_trap_i(1'b0),
    .complete_trap_cause_i(rv32_core_pkg::CORE_TRAP_NONE),
    .complete_mem_valid_i(1'b0),
    .complete_mem_write_i(1'b0),
    .complete_mem_addr_i(32'b0),
    .complete_mem_rmask_i(4'b0),
    .complete_mem_wmask_i(4'b0),
    .complete_mem_rdata_i(32'b0),
    .complete_mem_wdata_i(32'b0),
